...
RSpec.describe 'Contestant Index Page' do
  ...
  describe 'As a visitor, when I visit /contestants' do
    it 'I see a list of names of all the contestants and their projects' do
      ...
      expect(page).to have_content(@kentaro.projects.first.name)
      expect(page).to have_content(@erin.name)
      expect(page).to have_content(@erin.projects.first.name)
    end
  end
end